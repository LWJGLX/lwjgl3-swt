...
final public class OleFrame extends Composite
{
	...
	private int /*long*/ shellHandle;
	private int /*long*/ oldMenuHandle;
	private int /*long*/ newMenuHandle;
	private static int /*long*/ lastActivatedMenuHandle;
...
//	implements IUnknown, IOleInPlaceFrame, IOleContainer, IOleInPlaceUIWindow
	...
	if (COM.IsEqualGUID(guid, COM.IIDIUnknown) || COM.IsEqualGUID(guid, COM.IIDIOleInPlaceFrame) ) {
		OS.MoveMemory(ppvObject, new int /*long*/ [] {iOleInPlaceFrame.getAddress()}, C.PTR_SIZEOF);
		AddRef();
		return COM.S_OK;
	}
