...
public COMObject(int[] argCounts) {
	...
	int /*long*/ pVtable = OS.GlobalAlloc(COM.GMEM_FIXED | COM.GMEM_ZEROINIT, C.PTR_SIZEOF * argCounts.length);
	...
	OS.MoveMemory(ppVtable, new int /*long*/[] {pVtable}, C.PTR_SIZEOF);
