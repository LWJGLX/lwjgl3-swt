...
//	}
	...
	int QueryInterface(int /*long*/ iid, int /*long*/ ppvObject) {
		...
		if (COM.IsEqualGUID(guid, COM.IIDIDispatch) || COM.IsEqualGUID(guid, COM.IIDIAccessible)) {
			if (objIAccessible == null) createIAccessible();
			OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessible.getAddress() }, C.PTR_SIZEOF);
			AddRef();
		...
		if (COM.IsEqualGUID(guid, COM.IIDIEnumVARIANT)) {
			...
			OS.MoveMemory(ppvObject, new int /*long*/[] { objIEnumVARIANT.getAddress() }, C.PTR_SIZEOF);
			AddRef();
			enumIndex = 0;
		...
		if (COM.IsEqualGUID(guid, COM.IIDIServiceProvider)) {
			...
			if (accessibleActionListenersSize() > 0 || accessibleAttributeListenersSize() > 0 ||
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIServiceProvider.getAddress() }, C.PTR_SIZEOF);
				AddRef();
	...
	int queryAccessible2Interfaces(GUID guid, int /*long*/ ppvObject) {
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessible2)) {
			if (accessibleActionListenersSize() > 0 || accessibleAttributeListenersSize() > 0 ||
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessible2.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleAction)) {
			if (accessibleActionListenersSize() > 0) {
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleAction.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleApplication)) {
			...
			OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleApplication.getAddress() }, C.PTR_SIZEOF);
			AddRef();
			return COM.S_OK;
		}
...
//			}
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleEditableText)) {
			if (accessibleEditableTextListenersSize() > 0) {
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleEditableText.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleHyperlink)) {
			if (accessibleHyperlinkListenersSize() > 0) {
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleHyperlink.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleHypertext)) {
			if (accessibleTextExtendedListenersSize() > 0) {
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleHypertext.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
...
//			}
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleTable2)) {
			if (accessibleTableListenersSize() > 0) {
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleTable2.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleTableCell)) {
			if (accessibleTableCellListenersSize() > 0) {
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleTableCell.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleText)) {
			if (accessibleTextExtendedListenersSize() > 0 || accessibleAttributeListenersSize() > 0) {
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleText.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
		...
		if (COM.IsEqualGUID(guid, COM.IIDIAccessibleValue)) {
			if (accessibleValueListenersSize() > 0) {
				...
				OS.MoveMemory(ppvObject, new int /*long*/[] { objIAccessibleValue.getAddress() }, C.PTR_SIZEOF);
				AddRef();
				return COM.S_OK;
			}
			return COM.E_NOINTERFACE;
	...
	int get_accChild(int /*long*/ varChild, int /*long*/ ppdispChild) {
		...
		if (v.lVal == COM.CHILDID_SELF) {
			...
			AddRef();
			OS.MoveMemory(ppdispChild, new int /*long*/[] { getAddress() }, C.PTR_SIZEOF);
			return COM.S_OK;
		}
		...
		if (accessible != null) {
			...
			accessible.AddRef();
			OS.MoveMemory(ppdispChild, new int /*long*/[] { accessible.getAddress() }, C.PTR_SIZEOF);
			return COM.S_OK;
		}
	...
	int get_accParent(int /*long*/ ppdispParent) {
		...
		if (parent != null) {
			...
			parent.AddRef();
			OS.MoveMemory(ppdispParent, new int /*long*/[] { parent.getAddress() }, C.PTR_SIZEOF);
			code = COM.S_OK;
		}
	...
	int Clone(int /*long*/ ppEnum) {
		...
		OS.MoveMemory(ppEnum, new int /*long*/[] { objIEnumVARIANT.getAddress() }, C.PTR_SIZEOF);
		AddRef();
		return COM.S_OK;
	}
	...
	int get_relation(int relationIndex, int /*long*/ ppRelation) {
		...
		for (int type = 0; type < MAX_RELATION_TYPES; type++) {
			...
			if (i == relationIndex) {
				...
				relation.AddRef();
				OS.MoveMemory(ppRelation, new int /*long*/[] { relation.getAddress() }, C.PTR_SIZEOF);
				return COM.S_OK;
			}
		}
	...
	int get_relations(int maxRelations, int /*long*/ ppRelations, int /*long*/ pNRelations) {
		...
		for (int type = 0; type < MAX_RELATION_TYPES; type++) {
			...
			if (relation != null) {
				relation.AddRef();
				OS.MoveMemory(ppRelations + count * C.PTR_SIZEOF, new int /*long*/[] { relation.getAddress() }, C.PTR_SIZEOF);
				count++;
			}
		}
	...
	int get_uniqueID(int /*long*/ pUniqueID) {
		...
		OS.MoveMemory(pUniqueID, new int /*long*/ [] { uniqueID }, 4);
		return COM.S_OK;
	}
	...
	int get_windowHandle(int /*long*/ pWindowHandle) {
		...
		OS.MoveMemory(pWindowHandle, new int /*long*/ [] { control.handle }, C.PTR_SIZEOF);
		return COM.S_OK;
	}
...
//			}
	...
	int get_locale(int /*long*/ pLocale) {
		...
		OS.MoveMemory(pLocale, new int /*long*/[] {ptr}, C.PTR_SIZEOF);

		data = (locale.getCountry()+"\0").toCharArray();
		ptr = COM.SysAllocString(data);
		OS.MoveMemory(pLocale + C.PTR_SIZEOF, new int /*long*/[] {ptr}, C.PTR_SIZEOF);

		data = (locale.getVariant()+"\0").toCharArray();
		ptr = COM.SysAllocString(data);
		OS.MoveMemory(pLocale + 2 * C.PTR_SIZEOF, new int /*long*/[] {ptr}, C.PTR_SIZEOF);
...
//	}
	...
	int get_hyperlink(int index, int /*long*/ ppHyperlink) {
		...
		accessible.AddRef();
		OS.MoveMemory(ppHyperlink, new int /*long*/[] { accessible.getAddress() }, C.PTR_SIZEOF);
		return COM.S_OK;
	}
...
//	}
	...
	int get_cellAt(int row, int column, int /*long*/ ppCell) {
		...
		accessible.AddRef();
		OS.MoveMemory(ppCell, new int /*long*/[] { accessible.getAddress() }, C.PTR_SIZEOF);
		return COM.S_OK;
	}
	...
	int get_caption(int /*long*/ ppAccessible) {
		...
		if (accessible == null) {
			OS.MoveMemory(ppAccessible, new int /*long*/[] { 0 }, C.PTR_SIZEOF);
			return COM.S_FALSE;
		}
		accessible.AddRef();
		OS.MoveMemory(ppAccessible, new int /*long*/[] { accessible.getAddress() }, C.PTR_SIZEOF);
		return COM.S_OK;
	}
	...
	int get_selectedCells(int /*long*/ ppCells, int /*long*/ pNSelectedCells) {
		...
		if (event.accessibles == null || event.accessibles.length == 0) {
			OS.MoveMemory(ppCells, new int /*long*/[] { 0 }, C.PTR_SIZEOF);
			OS.MoveMemory(pNSelectedCells, new int [] { 0 }, 4);
			return COM.S_FALSE;
		}
		int length = event.accessibles.length;
		int /*long*/ pv = OS.CoTaskMemAlloc(length * C.PTR_SIZEOF);
		int count = 0;
		for (int i = 0; i < length; i++) {
			Accessible accessible = event.accessibles[i];
			if (accessible != null) {
				accessible.AddRef();
				OS.MoveMemory(pv + i * C.PTR_SIZEOF, new int /*long*/[] { accessible.getAddress() }, C.PTR_SIZEOF);
				count++;
			}
		}
		OS.MoveMemory(ppCells, new int /*long*/ [] { pv }, C.PTR_SIZEOF);
	...
	int get_selectedColumns(int /*long*/ ppSelectedColumns, int /*long*/ pNColumns) {
		...
		if (count == 0) {
			OS.MoveMemory(ppSelectedColumns, new int /*long*/[] { 0 }, C.PTR_SIZEOF);
			OS.MoveMemory(pNColumns, new int [] { 0 }, 4);
			return COM.S_FALSE;
		}
		int /*long*/ pv = OS.CoTaskMemAlloc(count * 4);
		OS.MoveMemory(pv, event.selected, count * 4);
		OS.MoveMemory(ppSelectedColumns, new int /*long*/ [] { pv }, C.PTR_SIZEOF);
	...
	int get_selectedRows(int /*long*/ ppSelectedRows, int /*long*/ pNRows) {
		...
		if (count == 0) {
			OS.MoveMemory(ppSelectedRows, new int /*long*/[] { 0 }, C.PTR_SIZEOF);
			OS.MoveMemory(pNRows, new int [] { 0 }, 4);
			return COM.S_FALSE;
		}
		int /*long*/ pv = OS.CoTaskMemAlloc(count * 4);
		OS.MoveMemory(pv, event.selected, count * 4);
		OS.MoveMemory(ppSelectedRows, new int /*long*/ [] { pv }, C.PTR_SIZEOF);
	...
	int get_modelChange(int /*long*/ pModelChange) {
		...
		if (tableChange == null) {
			OS.MoveMemory(pModelChange, new int /*long*/ [] { 0 }, C.PTR_SIZEOF);
			return COM.S_FALSE;
		}
	...
	int get_columnHeaderCells(int /*long*/ ppCellAccessibles, int /*long*/ pNColumnHeaderCells) {
		...
		if (event.accessibles == null || event.accessibles.length == 0) {
			OS.MoveMemory(ppCellAccessibles, new int /*long*/[] { 0 }, C.PTR_SIZEOF);
		...
		OS.MoveMemory(ppCellAccessibles, new int /*long*/ [] { pv }, C.PTR_SIZEOF);
...
//		return COM.S_OK;
	...
	int get_table(int /*long*/ ppTable) {
		...
		if (accessible == null) {
			...
			OS.MoveMemory(ppTable, new int /*long*/[] { 0 }, C.PTR_SIZEOF);
			return COM.S_FALSE;
		}
		accessible.AddRef();
		OS.MoveMemory(ppTable, new int /*long*/[] { accessible.getAddress() }, C.PTR_SIZEOF);
		return COM.S_OK;
	}
	...
	void setPtrVARIANT(int /*long*/ variant, short vt, int /*long*/ lVal) {
		if (vt == COM.VT_DISPATCH || vt == COM.VT_UNKNOWN) {
			OS.MoveMemory(variant, new short[] { vt }, 2);
			OS.MoveMemory(variant + 8, new int /*long*/ [] { lVal }, C.PTR_SIZEOF);
		}
	}
	...
	void setStringVARIANT(int /*long*/ variant, String string) {
		...
		OS.MoveMemory(variant + 8, new int /*long*/ [] { ptr }, C.PTR_SIZEOF);
	}
