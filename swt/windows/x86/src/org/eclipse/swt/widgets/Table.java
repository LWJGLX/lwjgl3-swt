...
public class Table extends Composite {
	...
	int /*long*/ headerToolTipHandle, hwndHeader;
...
void showItem (int index) {
	...
	*/
	int /*long*/ counterPage = OS.SendMessage (handle, OS.LVM_GETCOUNTPERPAGE, 0, 0);
	if (counterPage <= 0) {
		/*
		* Bug in Windows.  For some reason, LVM_ENSUREVISIBLE can
		* scroll one item more or one item less when there is not
		...
		*/
		 ...
		 */
		int /*long*/  topIndex = OS.SendMessage (handle, OS.LVM_GETTOPINDEX, 0, 0);
