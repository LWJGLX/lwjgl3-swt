...
public class Combo extends Composite {
	int /*long*/ buttonHandle, entryHandle, textRenderer, cellHandle, popupHandle, menuHandle, buttonBoxHandle, cellBoxHandle;
...
void clearText () {
	...
	if ((style & SWT.READ_ONLY) != 0) {
		...
		if (index != -1) {
			int /*long*/ modelHandle = GTK.gtk_combo_box_get_model (handle);
...
Point computeSizeInPixels (int wHint, int hHint, boolean changed) {
	...
	int /*long*/ layout = GTK.gtk_entry_get_layout (entryHandle);
	...
	int /*long*/ listParent = GTK.gtk_bin_get_child(popupHandle);
...
void createHandle (int index) {
	...
	int /*long*/ oldList = GTK.gtk_window_list_toplevels ();
	if ((style & SWT.READ_ONLY) != 0) {
...
int /*long*/ findPopupHandle (int /*long*/ oldList) {
	int /*long*/ result = 0;
	int /*long*/ currentList = GTK.gtk_window_list_toplevels();
...
public int getCaretPosition () {
	...
	int /*long*/ ptr = GTK.gtk_entry_get_text (entryHandle);
...
public String getText () {
	checkWidget();
	if (entryHandle != 0) {
		int /*long*/ str = GTK.gtk_entry_get_text (entryHandle);
		if (str == 0) return "";
...
int /*long*/ gtk_draw (int /*long*/ widget, int /*long*/ cairo) {
	 ...
	 */
	if (GTK.GTK_VERSION >= OS.VERSION(3, 20, 0)) {
		int /*long*/ parentHandle = GTK.gtk_widget_get_parent(fixedHandle);
		if (parentHandle != 0) {
			if (parent.fixClipHandle == 0) parent.fixClipHandle = parentHandle;
			if (firstDraw) {
				if ((style & SWT.READ_ONLY) != 0) {
					int /*long*/ [] array = {fixedHandle, handle, buttonBoxHandle, buttonHandle, cellBoxHandle, cellHandle};
					parent.fixClipMap.put(this, array);
				} else {
					int /*long*/ [] array = {fixedHandle, handle, entryHandle, buttonBoxHandle, buttonHandle};
					parent.fixClipMap.put(this, array);
				}
				firstDraw = false;
