...
int /*long*/ checkIfEventProc (int /*long*/ display, int /*long*/ xEvent, int /*long*/ userData) {
	...
	int /*long*/ window = GDK.gdk_x11_window_lookup_for_display(GDK.gdk_display_get_default(), OS.X_EVENT_WINDOW (xEvent));
...
void initializeWindowManager () {
	...
	if (OS.isX11()) {
		int /*long*/ screen = GDK.gdk_screen_get_default ();
		if (screen != 0) {
			int /*long*/ ptr2 = GDK.gdk_x11_screen_get_window_manager_name (screen);
			if (ptr2 != 0) {
...
Widget removeWidget (int /*long*/ handle) {
	...
	Widget widget = null;
	int index;
	int /*long*/ data = OS.g_object_get_qdata (handle, SWT_OBJECT_INDEX) - 1;
...
String debugInfoForIndex(int /*long*/ index) {
...
int /*long*/ setDirectionProc (int /*long*/ widget, int /*long*/ direction) {
	...
	if (GTK.GTK_IS_MENU_ITEM (widget)) {
		int /*long*/ submenu = GTK.gtk_menu_item_get_submenu (widget);
		if (submenu != 0) {
...
int /*long*/ gdk_device_get_window_at_position (int[] win_x, int[] win_y) {
	if (GTK.GTK3) {
		int /*long*/ display = GDK.gdk_display_get_default ();
		int /*long*/ device = GDK.gdk_get_pointer(display);
 ...
 */
@Override
protected int /*long*/ gsettingsProc (int /*long*/ gobject, int /*long*/ arg1, int /*long*/ user_data) {
	switch((int)/*64*/user_data) {
...
static int _getDeviceZoom (int /*long*/ monitor_num) {
	int /*long*/ screen = GDK.gdk_screen_get_default ();
