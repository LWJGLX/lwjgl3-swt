...
public class MenuItem extends Item {
	Menu parent, menu;
	int /*long*/ groupHandle, labelHandle, imageHandle;
	...
	switch (style & bits) {
		...
		case SWT.RADIO:
			...
			*/
			...
			int /*long*/ group = GTK.gtk_radio_menu_item_get_group (groupHandle);
			if (GTK.GTK3) {
...
private void setAccelLabel(int /*long*/ label, String accelString) {
	...
	int /*long*/ oldPtr = GTK.GTK_ACCEL_LABEL_GET_ACCEL_STRING (label);
