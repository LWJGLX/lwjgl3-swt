...
public GLCanvas (Composite parent, int style, GLData data) {
	...
	int /*long*/ xDisplay = GDK.gdk_x11_display_get_xdisplay(GDK.gdk_window_get_display(window));
	...
	int /*long*/ gdkvisual = GDK.gdk_x11_screen_lookup_visual (screen, vinfo.visualid);
	...
	Listener listener = event -> {
		...
		case SWT.Resize:
			...
			break;
		case SWT.Dispose:
			int /*long*/ window1 = GTK.gtk_widget_get_window (handle);
			int /*long*/ xDisplay1 = gdk_x11_display_get_xdisplay (window1);
			if (context != 0) {
