...
public class GDBus {
	...
	private static int /*long*/ onBusAcquired (int /*long*/ gDBusConnection, int /*long*/ const_gchar_name, int /*long*/ user_data) {
		...
		{ // Register object
			...
			int /*long*/ vtable [] = { handleMethod.getAddress(), 0, 0 };
	...
	@SuppressWarnings("unused") // Callback Only called directly by JNI.
	private static int /*long*/ onNameAcquired (int /*long*/ connection, int /*long*/ name, int /*long*/ user_data) {
		// Currently not used, but can be used if acquring the gdbus name should trigger something to load.
		return 0;
	}

	@SuppressWarnings("unused") // Callback Only called directly by JNI.
	private static int /*long*/ onNameLost (int /*long*/ connection, int /*long*/ name, int /*long*/ user_data) {
	 ...
	 */
	@SuppressWarnings("unused") // Callback only called directly by JNI.
	private static int /*long*/ handleMethod (
	...
	private static Object convertGVariantToJavaHelper(int /*long*/ gVariant){
		// - Developer note:
