...
static int /*long*/ DragBegin(int /*long*/ widget, int /*long*/ context){
...
void dragBegin(int /*long*/ widget, int /*long*/ context) {
	/*
...
void dragEnd(int /*long*/ widget, int /*long*/ context){
	 ...
	 */
	if (GTK.GTK3) {
		int /*long*/ display = GDK.gdk_window_get_display(GTK.gtk_widget_get_window(widget));
		int /*long*/ pointer = GDK.gdk_get_pointer(display);
		int /*long*/ keyboard = GDK.gdk_device_get_associated_device(pointer);
	...
	if (!OS.isX11()) { // Wayland
		...
		if (this.control instanceof Table
			...
			int /*long*/ selection = GTK.gtk_tree_view_get_selection (widget);
...
void dragGetData(int /*long*/ widget, int /*long*/ context, int /*long*/ selection_data,  int info, int time){
	...
	int /*long*/ data = GTK.gtk_selection_data_get_data(selection_data);
	int /*long*/ target = GTK.gtk_selection_data_get_target(selection_data);
	if (target == 0) return;
