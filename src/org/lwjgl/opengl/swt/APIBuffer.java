 ...
 * 
 * <p>
 * Note from Kai Burjack: This is a copy of LWJGL 3's previous APIBuffer
 * to make the SWT binding work again. I'll switch to new allocation APIs
 * soon. 
 */
public class APIBuffer {
	...
	public APIBuffer() {
		buffer = MemoryUtil.memAlignedAlloc(32, DEFAULT_CAPACITY);
	...
	private void ensureCapacity(int capacity) {
		...
		ByteBuffer resized = MemoryUtil.memAlignedAlloc(32, mathRoundPoT(capacity));
